    ...
    for i in clase:
            if mes < 10:
                if dia < 10:
                    ...
                    cadena = str(año) + "-0" + str(mes) + "-0" + str(dia) + "," + str(año) + "," + i+","+str(findDay(str(dia)+" "+str(mes)+" "+str(año)))+","+str(semana)+",0" + str(mes)+","+festivos(fecha)
                    lista_def=[fecha,año,i,str(findDay(str(dia)+" "+str(mes)+" "+str(año))),semana,"0" + str(mes),festivos(fecha)]
                else:
                    fecha=str(año) + "-0" + str(mes) + "-" + str(dia)
                    cadena = str(año) + "-0" + str(mes) + "-" + str(dia) + "," + str(año) + "," + i+","+str(findDay(str(dia)+" "+str(mes)+" "+str(año)))+","+str(semana)+",0" + str(mes)+","+festivos(fecha)
                    lista_def = [fecha, año, i, str(findDay(str(dia) + " " + str(mes) + " " + str(año))), semana,
                                 "0" + str(mes), festivos(fecha)]
            else:
                if dia < 10:
                    fecha=str(año) + "-" + str(mes) + "-0" + str(dia)
                    cadena = str(año) + "-" + str(mes) + "-0" + str(dia) + "," + str(año) + "," + i+","+str(findDay(str(dia)+" "+str(mes)+" "+str(año)))+","+str(semana)+"," + str(mes)+","+festivos(fecha)
                    lista_def = [fecha, año, i, str(findDay(str(dia) + " " + str(mes) + " " + str(año))), semana,str(mes), festivos(fecha)]
                else:
                    fecha=str(año) + "-" + str(mes) + "-" + str(dia)
                    cadena = str(año) + "-" + str(mes) + "-" + str(dia) + "," + str(año) + "," + i+","+str(findDay(str(dia)+" "+str(mes)+" "+str(año)))+","+str(semana)+"," + str(mes)+","+festivos(fecha)
                    lista_def = [fecha, año, i, str(findDay(str(dia) + " " + str(mes) + " " + str(año))), semana,
                                 str(mes), festivos(fecha)]

            if (mes == 1 or mes == 3 or mes == 5 or mes == 7 or mes == 8 or mes == 10) and i == 'Caida Ocupante':
                if dia == 31:
                    mes = mes + 1
                    dia = 0
            elif (mes == 4 or mes == 6 or mes == 9 or mes == 11) and i == 'Caida Ocupante' :
                if dia == 30:
                    mes = mes + 1
                    dia = 0
            elif mes == 2 and i == 'Caida Ocupante':
                if dia == 28:
                    mes = mes + 1
                    dia = 0
            elif mes == 12:
                if dia == 31 and i == 'Caida Ocupante':
                    año = año + 1
                    mes = 1
                    dia = 0
                    semana=1
...
with open('prediccion_sin_comuna.csv', 'w', encoding="utf-8") as file:
