...
cadena=""
lista=[]
clase=['Choque','Atropello','Otro','Caida de Ocupante','Volcamiento','Incendio']
...
while(True):
    for i in clase:
        for j in comunas:
            ...
            if (mes == 1 or mes == 3 or mes == 5 or mes == 7 or mes == 8 or mes == 10) and i == 'Incendio' and j =='VILLA HERMOSA':
                if dia == 31:
                    mes = mes + 1
                    dia = 0
            elif (mes == 4 or mes == 6 or mes == 9 or mes == 11) and i == 'Incendio' and j =='VILLA HERMOSA' :
                if dia == 30:
                    mes = mes + 1
                    dia = 0
            elif mes == 2 and i == 'Incendio' and j =='VILLA HERMOSA':
                if dia == 28:
                    mes = mes + 1
                    dia = 0
            elif mes == 12:
                if dia == 31 and i == 'Incendio' and j =='VILLA HERMOSA':
                    año = año + 1
                    mes = 1
                    dia = 0
                    semana=1
...
with open('prediccion_corregida.csv', 'w', encoding="utf-8") as file:
